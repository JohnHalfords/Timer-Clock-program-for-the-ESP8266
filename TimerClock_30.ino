...
// What can you expect in 3.x:
// Config page that holds the most inportant configs for the user like myTimeZone, myLatitude, myLongitude, TimesGPIO, GPIOdelay, GPIOhightime, HistoryPage (on/off)
...
String version$ = "v3.0";                                     // Version of program
...
/* Addresses:
  25 -  280 HTTPcommandOn[1]
 281 -  535 HTTPcommandOff[1]
 536 -  790 HTTPcommandOn[2]
 791 - 1045 HTTPcommandOff[2]
1046 - 1300 HTTPcommandOn[3]
1301 - 1555 HTTPcommandOff[3]
1556 - 1810 HTTPcommandOn[4]
1811 - 2065 HTTPcommandOff[4]
 */
...
void wwwroot()
{
  ...
  webpage += "<hr><form action='/' method='POST'><input type='hidden' name='go'>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type='submit' value='Refresh'></form></p>";
...
void MakeHeaderFooter()
{
  ...
  if (HistoryPage == 0) webpageheader += " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a href='/'>Info</a> &nbsp; <a href='/command'>Command</a></strong></p><hr>";
  if (HistoryPage == 1) webpageheader += " <a href='/history'>History</a> &nbsp; <a href='/'>Info</a> &nbsp; &nbsp; <a href='/command'>Command</a></strong></p><hr>";
